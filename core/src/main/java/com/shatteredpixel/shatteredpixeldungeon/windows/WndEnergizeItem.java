...
public class WndEnergizeItem extends WndInfoItem {
	...
	public static void energize( Item item ) {
		...
		if (JourneyPixelDungeon.scene() instanceof AlchemyScene){
			...
			((AlchemyScene) JourneyPixelDungeon.scene()).createEnergy();
	...
	public static WndBag openItemSelector(){
		if (JourneyPixelDungeon.scene() instanceof GameScene) {
			...
			JourneyPixelDungeon.scene().addToFront(window);
			return window;
		}
	}
		...
		public void onSelect(Item item) {
			if (item != null) {
				...
				if (JourneyPixelDungeon.scene() instanceof GameScene) {
					...
					JourneyPixelDungeon.scene().addToFront(new WndEnergizeItem(item, parentWnd));
				}
			}
		}
	};
