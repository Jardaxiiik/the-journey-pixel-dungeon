...
public class SecretMazeRoom extends SecretRoom {
	...
	public void paint(Level level) {
		...
		do {
			if (Random.Int(2) == 0) {
				prize = ItemGenerator.randomWeapon((Dungeon.depth / 5) + 1, true);
			} else {
				prize = ItemGenerator.randomArmor((Dungeon.depth / 5) + 1);
			}
		...
		level.dropItemOnPosition(prize, level.pointToCell(bestDistP)).type = Heap.Type.CHEST;
