...
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.GreatCrab;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.FetidRat;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.GnollTrickster;
	...
	public static class Quest {
		...
		public static void spawn( SewerLevel level, Room room ) {
			if (!spawned && Dungeon.depth > 1 && Random.Int( 5 - Dungeon.depth ) == 0) {
				...
				weapon = (Weapon) ItemGenerator.random(ItemGenerator.wepTiers[wepTier - 1]);
