...
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Bat;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Brute;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Crab;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.DM100;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.DM200;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Elemental;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Eye;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Ghoul;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Gnoll;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Golem;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Guard;
...
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Scorpio;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Shaman;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Skeleton;
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Slime;
...
import com.shatteredpixel.shatteredpixeldungeon.actors.characters.mobs.Succubus;
...
public class AscensionChallenge extends Buff {
	...
	public static float statModifier(Character ch){
		...
		if (ch.getBuff(AscensionBuffBlocker.class) != null){
			return 1f;
		}
	...
	public static float modifyHeroSpeed(float speed){
		if (Dungeon.hero.getBuff(AscensionChallenge.class) != null
				&& Dungeon.hero.getBuff(AscensionChallenge.class).stacks > 6f){
	...
	public static void processEnemyKill(Character enemy){
		AscensionChallenge chal = Dungeon.hero.getBuff(AscensionChallenge.class);
		if (chal == null) return;
		...
		if (enemy.getBuff(AscensionBuffBlocker.class) != null){
			return;
		}
	...
	public static int AscensionCorruptResist(Mob m){
		...
		if (m.getBuff(AscensionBuffBlocker.class) != null){
			return m.EXP;
		}
	...
	public void onLevelSwitch(){
		if (Dungeon.depth < Statistics.highestAscent){
			...
			if (Dungeon.bossLevel()){
				Dungeon.hero.getBuff(Hunger.class).satisfy(Hunger.STARVING);
				Buff.affect(Dungeon.hero, Healing.class).setHeal(Dungeon.hero.healthMax, 0, 20);
			} else {
				stacks += 2f;
